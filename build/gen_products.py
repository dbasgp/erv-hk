...
PRODUCTS = [
    ...
    # ===== GEC LD (Commercial Ceiling) — kept from earlier =====
    {
        "sku": "DBA-GEC68LD-HP",
        "image": "ceiling-dba-gec68ld-1.jpg",
        "series_eyebrow_zh": "商用天花抽濕機 · GEC LD 系列",
        "series_eyebrow_en": "Commercial ceiling · GEC LD Series",
        "tag_zh": None, "tag_en": None,
    ...
    },
    {
        ...
        "series_eyebrow_en": "Commercial ceiling · GEC LD Series",
        "tag_zh": None, "tag_en": None,
        "headline_zh": "GEC LD 系列最大型號。",
        "headline_en": "The largest GEC LD ceiling unit.",
    ...
    <div class="container">
      <div class="ph-h-grid">
        ...
        <div class="ph-h-card">
          ...
          <p><span lang-zh>原廠 2 年保養 (壓縮機 5 年)，香港工程隊負責安裝、調試、保養及維修。CE / CB / ISO 9001 / RoHS 認證。</span><span lang-en>2-year warranty (5-year compressor). Hong Kong engineering team for install, commissioning, service, and repair. CE / CB / ISO 9001 / RoHS certified.</span></p>
        </div>
      </div>
    </div>
  </section>
